...
> Offizielle Dokumentation für [atc-dns](https://github.com/A-TownChain-Okosystems/atc-dns) — **Dezentrales DNS (.atc)** im A-TownChain Ökosystem

[![Code](https://img.shields.io/badge/Code-atc--dns-blue)](https://github.com/A-TownChain-Okosystems/atc-dns)
...
**→ [atc-dns](https://github.com/A-TownChain-Okosystems/atc-dns)** (`main` Branch)
